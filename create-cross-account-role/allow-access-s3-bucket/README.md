...
- One trusted role: [json](https://github.com/valentine-dev/aws-cloudformation/blob/master/create-cross-account-role/allow-access-s3-bucket/trust-one-role/template.json), [yaml](https://github.com/valentine-dev/aws-cloudformation/blob/master/create-cross-account-role/allow-access-s3-bucket/trust-one-role/template.yaml)
- Multiple trusted roles: [json](https://github.com/valentine-dev/aws-cloudformation/blob/master/create-cross-account-role/allow-access-s3-bucket/trust-multiple-roles/template.json), [yaml](https://github.com/valentine-dev/aws-cloudformation/blob/master/create-cross-account-role/allow-access-s3-bucket/trust-multiple-roles/template.yaml)
