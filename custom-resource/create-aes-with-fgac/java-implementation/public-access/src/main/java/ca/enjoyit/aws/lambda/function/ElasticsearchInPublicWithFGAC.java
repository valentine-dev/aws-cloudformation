 ...
 * 
 */
public class ElasticsearchInPublicWithFGAC implements RequestHandler<CustomResourceRequest, String> {

	final private static Log logger = LogFactory.getLog(ElasticsearchInPublicWithFGAC.class);
